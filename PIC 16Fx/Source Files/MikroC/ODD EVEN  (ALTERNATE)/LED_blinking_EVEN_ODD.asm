...
;  Date/Time: 9/2/2016 11:27:31 PM
...
$0004	$	_main:
;LED_blinking_EVEN_ODD.c,1 :: 		void main()
;LED_blinking_EVEN_ODD.c,3 :: 		TRISB=0X00;
$0004	$1303			BCF	STATUS, RP1
$0005	$1683			BSF	STATUS, RP0
$0006	$0186			CLRF	TRISB, 1
;LED_blinking_EVEN_ODD.c,4 :: 		PORTB=0XAA;
$0007	$30AA			MOVLW	170
$0008	$1283			BCF	STATUS, RP0
$0009	$0086			MOVWF	PORTB
;LED_blinking_EVEN_ODD.c,5 :: 		DELAY_ms(1000);
$000A	$300B			MOVLW	11
...
$0027	$2826			GOTO	$-1
;LED_blinking_EVEN_ODD.c,6 :: 		PORTB=0X55;
$0028	$3055			MOVLW	85
$0029	$0086			MOVWF	PORTB
;LED_blinking_EVEN_ODD.c,7 :: 		DELAY_ms(1000);
$002A	$300B			MOVLW	11
