...
;  Date/Time: 9/15/2016 10:16:19 PM
...
$0004	$	_main:
;LED_blinking_test_hex.c,1 :: 		void main()
;LED_blinking_test_hex.c,3 :: 		TRISB=0;
$0004	$1303			BCF	STATUS, RP1
$0005	$1683			BSF	STATUS, RP0
$0006	$0186			CLRF	TRISB, 1
;LED_blinking_test_hex.c,4 :: 		PORTB=0XFF;       //complete port
$0007	$30FF			MOVLW	255
$0008	$1283			BCF	STATUS, RP0
$0009	$0086			MOVWF	PORTB
;LED_blinking_test_hex.c,5 :: 		DELAY_ms(1000);
$000A	$300B			MOVLW	11
...
$0027	$2826			GOTO	$-1
;LED_blinking_test_hex.c,6 :: 		PORTB=0X00;
$0028	$0186			CLRF	PORTB, 1
;LED_blinking_test_hex.c,7 :: 		DELAY_ms(1000);
$0029	$300B			MOVLW	11
$002A	$00FC			MOVWF	STACK_12
$002B	$30FF			MOVLW	255
$002C	$00FB			MOVWF	STACK_11
$002D	$30FF			MOVLW	255
$002E	$00FA			MOVWF	STACK_10
$002F	$0BFC			DECFSZ	STACK_12, F
$0030	$2832			GOTO	$+2
$0031	$2839			GOTO	$+8
