...
;  Date/Time: 9/15/2016 10:17:48 PM
...
$0004	$	_main:
;pins_command.c,1 :: 		void main()
;pins_command.c,3 :: 		TRISB=0;
$0004	$1303			BCF	STATUS, RP1
$0005	$1683			BSF	STATUS, RP0
$0006	$0186			CLRF	TRISB, 1
;pins_command.c,4 :: 		PORTB=137;  //led ON 1,4,8
$0007	$3089			MOVLW	137
$0008	$1283			BCF	STATUS, RP0
$0009	$0086			MOVWF	PORTB
;pins_command.c,5 :: 		DELAY_ms(1000);
$000A	$300B			MOVLW	11
...
$0027	$2826			GOTO	$-1
;pins_command.c,6 :: 		PORTB=0;
$0028	$0186			CLRF	PORTB, 1
;pins_command.c,7 :: 		DELAY_ms(1000);
$0029	$300B			MOVLW	11
